...
router.get("/festive", async (req, res)=>{
    ...
    try{
     ...
     product = product.filter(product => product.category==="FESTIVE");
     console.log(product);
     success = true;
     res.json({success, product});
...
router.get("/saree", async (req, res)=>{
    ...
    try{
     ...
     product = product.filter(product => product.category==="Saree");
     console.log(product);
     success = true;
     res.json({success, product});
...
router.get("/dupatta", async (req, res)=>{
    ...
    try{
     ...
     product = product.filter(product => product.category==="Dupatta");
     console.log(product);
     success = true;
     res.json({success, product});
...
router.get("/bag", async (req, res)=>{
    ...
    try{
     ...
     product = product.filter(product => product.category==="Bag");
     console.log(product);
     success = true;
     res.json({success, product});
...
router.get("/jewellery", async (req, res)=>{
    ...
    try{
     ...
     product = product.filter(product => product.category==="Jewellery");
     console.log(product);
     success = true;
     res.json({success, product});
